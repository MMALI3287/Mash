        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkBox1.isChecked()&&checkBox2.isChecked()){
                    Toast.makeText(MainActivity.this,"You have to select any one option",Toast.LENGTH_SHORT).show();
                }
                    ...
                    Toast.makeText(MainActivity.this,"You have to select at least one option",Toast.LENGTH_SHORT).show();
                }
